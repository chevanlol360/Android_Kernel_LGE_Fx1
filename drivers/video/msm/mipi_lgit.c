...
static char osc_setting[3] =     {0xC0, 0x00, 0x04};
static char power_setting3[10] = {0xC3, 0x00, 0x09, 0x10, 0x15, 0x01, 0x12, 0x3e, 0x24, 0x02};
...
#if defined (CONFIG_FB_MSM_MIPI_LGIT_LH470WX1_VIDEO_HD_PT)
static void mipi_lgit_lcd_shutdown(struct platform_device *pdev)
{
	mipi_lgit_lcd_off(pdev);
