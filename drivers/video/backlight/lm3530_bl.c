...
#if defined (CONFIG_FB_MSM_MIPI_LGD_VIDEO_QHD_PT_PANEL) || defined(CONFIG_FB_MSM_MIPI_LGIT_LH470WX1_VIDEO_HD_PT)
...
static struct early_suspend early_suspend;
	...
	|| defined (CONFIG_FB_MSM_MIPI_HITACHI_VIDEO_QHD_PT) || defined(CONFIG_FB_MSM_MIPI_LGIT_LH470WX1_VIDEO_HD_PT)
...
void lm3530_backlight_on(int level)
{
		...
		(defined(CONFIG_FB_MSM_MIPI_LGD_VIDEO_QHD_PT_PANEL)|| defined(CONFIG_FB_MSM_MIPI_HITACHI_VIDEO_QHD_PT) || defined(CONFIG_FB_MSM_MIPI_LGIT_LH470WX1_VIDEO_HD_PT))
	...
	defined (CONFIG_FB_MSM_MIPI_LGIT_LH470WX1_VIDEO_HD_PT) || \
...
#ifdef CONFIG_HAS_EARLYSUSPEND
#if defined(CONFIG_FB_MSM_MIPI_LGD_VIDEO_QHD_PT_PANEL) || defined(CONFIG_FB_MSM_MIPI_HITACHI_VIDEO_QHD_PT) || defined(CONFIG_FB_MSM_MIPI_LGIT_LH470WX1_VIDEO_HD_PT)
