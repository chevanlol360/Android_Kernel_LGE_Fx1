...
static int fastchg_irq_high_transition = -EINVAL;
...
static irqreturn_t fastchg_irq_handler(int irq, void *data)
{
	...
	int high_transition;
#ifdef CONFIG_LGE_WIRELESS_CHARGER
	pr_info("[WIRELESS] FAST IRQ START\n");
#endif
...
#if defined(CONFIG_MACH_MSM8960_L_DCM) || defined(CONFIG_MACH_MSM8960_L1v) || defined(CONFIG_MACH_MSM8960_FX1SK)
		stop_charging_status = 1;
#endif
		chg_batt_temp_state = CHG_BATT_STOP_CHARGING_STATE;
...
#ifndef CONFIG_LGE_WIRELESS_CHARGER
	if (fastchg_irq_high_transition == 1) {
		pr_info("fastchg_irq : high_transition = %d & eoc start \n", fastchg_irq_high_transition);
		fastchg_irq_high_transition = -EINVAL;
	}
#endif
...
#if defined (CONFIG_MACH_MSM8960_FX1S)
