...
/* LGE_CHANGE_S, variable rate video default setting, 2013-03-10, ejoon.kim@lge.com */
#ifdef CONFIG_MACH_MSM8960_FX1
static struct msm_camera_i2c_reg_conf imx111_video_default_settings[] = {
	/*LGE_CHANGE_S
	Add sensor's option able to flip and morror to correct orientation
	2011.11.15 jinsang.yun@lge.com
	Seperate D1L-a from others
	2011.12.19 ku.kwon@lge.com
	*/
#ifdef CONFIG_MACH_MSM8960_FX1 //* LGE_CHANGE, add for FX1 Camer, 2012.07.10 jihyun.song */
	{0x0101, 0x03}, /* read out direction */
#else
	{0x0101, 0x00}, /* read out direction */
#endif
...
#endif
/* LGE_CHANGE_E, variable rate video default setting, 2013-03-10, ejoon.kim@lge.com */
...
#ifdef CONFIG_MACH_MSM8960_FX1 //* LGE_CHANGE, variable rate video default setting, 2013-03-10, ejoon.kim@lge.com
	{&imx111_video_default_settings[0],
	ARRAY_SIZE(imx111_video_default_settings), 0, MSM_CAMERA_I2C_BYTE_DATA},
#endif
...
#ifdef CONFIG_MACH_MSM8960_FX1	//* LGE_CHANGE, flicker fix for F7, 2013-03-10, jinkwan.kim@lge.com */
		.frame_length_lines = 0x791, // 0x75C,//camcorder flicker
#else
...
#ifdef CONFIG_MACH_MSM8960_FX1	//* LGE_CHANGE, variable rate video default setting, 2013-03-10, ejoon.kim@lge.com */
	{
		/* 30 fps video default */
		.x_output = 0x668, /* 1640 */
		.y_output = 0x4D0, /* 1232 */
		.line_length_pclk = 0xDD0, /* 3536 */
		.frame_length_lines = 0x508, // 0x4E6, /* 1254 *///camcorder flicker
		.vt_pixel_clk = 134400000,
		.op_pixel_clk = 134400000,
		.binning_factor = 1,
	},
...
static int imx111_read_eeprom_data(struct msm_sensor_ctrl_t *s_ctrl, struct sensor_cfg_data *cfg)
{
	...
	if(imx_i2c_read_eeprom_burst(IMX111_EEPROM_SADDR | 0x3 /* page_no:3 */,
		...
		#else //R-rate change 2012-07-25(G-8M)
		eepromdata, IMX111_EEPROM_PAGE_SIZE) < 0) {
		#endif
