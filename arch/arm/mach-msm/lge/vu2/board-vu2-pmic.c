...
/* LGE_CHANGE_S [dongju99.kim@lge.com] 2012-12-06 */// 2-color led
...
/* LGE_CHANGE_S [dongju99.kim@lge.com] 2012-09-13 */
// charging led pattern (RED) & end of charging led pattern (GREEN)
static int pm8921_led0_pwm_duty_pcts0[60] = {
        10, 10, 11, 13, 15, 17, 19, 24, 30, 34,
		36, 40, 42, 48, 50, 55, 58, 62, 66, 70,
		74, 78, 82, 86, 90, 90, 86, 82, 78, 74,
		70, 64, 62, 58, 54, 52, 50, 48, 46, 44,
		42, 40, 38, 36, 38, 36, 32, 34, 30, 26,
		23, 22, 21, 19, 17, 15, 13, 11, 10, 10
};
// notify led pattern (GREEN)
...
/* LGE_CHANGE_E [dongju99.kim@lge.com] 2012-09-05 */
...
/* LGE_CHANGE_E [dongju99.kim@lge.com] 2012-12-06 */ // 2-color led
...
static struct i2c_registry fx1_i2c_pm_subsystem __initdata = {
...
static void __init lge_add_i2c_pm_subsystem_devices(void)
{
	...
	i2c_register_board_info(fx1_i2c_pm_subsystem.bus,
				fx1_i2c_pm_subsystem.info,
				fx1_i2c_pm_subsystem.len);
}
...
void __init msm8960_init_pmic(void)
{
	...
	if (machine_is_msm8960_liquid()) {
		...
		pm8921_platform_data.leds_pdata = &pm8xxx_leds_pdata;
