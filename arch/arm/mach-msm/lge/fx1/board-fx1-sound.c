...
static struct i2c_registry fx1_i2c_fmradio_revA __initdata = {
	I2C_SURF | I2C_FFA | I2C_FLUID | I2C_RUMI,
...
static struct i2c_registry fx1_i2c_fmradio __initdata = {
	I2C_SURF | I2C_FFA | I2C_FLUID | I2C_RUMI,
...
static void __init lge_add_i2c_fmradio_devices(void)
{
	...
	{
		i2c_register_board_info(fx1_i2c_fmradio_revA.bus,
					fx1_i2c_fmradio_revA.info,
					fx1_i2c_fmradio_revA.len);
	}
	else
	{
		i2c_register_board_info(fx1_i2c_fmradio.bus,
					fx1_i2c_fmradio.info,
					fx1_i2c_fmradio.len);	
	}
}
